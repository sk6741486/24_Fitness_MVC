...
namespace _24_Fitness_MVC.Controllers
{
    public class TrainersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Trainer_Name,Trainer_Phone,Trainer_Adress,Specialization")] Trainer trainer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Trainer_Name,Trainer_Phone,Trainer_Adress,Specialization")] Trainer trainer)
        {
            if (id != trainer.Id)
            {
                return NotFound();
